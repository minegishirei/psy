...
- 要件定義のユーザーコントロールがうまくいかない
- 自分のプロダクトとその技術の価値を顧客に伝えたい
- 心理学は知っているが、うまく使いこなせない
- 企画を通すための力が足りない
- 1on1でのコミュニケーションがうまくいかない
...
ほかの心理学の書籍同様、この記事でも「一貫性の法則」「バーナム効果」「希少価値」などの言葉を扱います。

ですが実際、心理学の難しさは膨大な知識の中から、正解を選ぶことの難易度に由来します。
加えて、それらの効果が必ずしも効き目があるとは限らず、確率に依存しています。

**心理学の本当の難しさは、定理の多さと不確実性に由来します**

これらに対抗する方法として

- チートシートを作ること。
- 特に重要な会議は、「どのタイミングで」「どんな言葉で」「どんなトーンで」発するのかをあらかじめ書いておくこと。
- プラン通りにいかないことも見越して、複数の分岐を想定しておくこと。

のように、コンポーネントとその応用方法について

特に、チートシートについては以下のようなシートを用意しました。
