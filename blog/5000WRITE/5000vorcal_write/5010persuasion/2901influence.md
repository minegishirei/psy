...
- action:生存率の提示
- example:癌の外科手術の効果について死亡率の代わりに生存率が示された場合、医師が手術を選択する割合は34%増加した
- effect:促進行動
...
- action:死亡率を提示せよ
- example:「アクションAが仮に成功すると、プロジェクトは正常に戻りますが、25%の確率で失敗します。」
- effect:回避行動
...
page:https://psy.hatenadiary.com/entry/2025/01/27/210454
